...
export const MENU_ITEMS: FoodItem[] = [
  {
    ...
    spicy: true,
    popular: true,
    tags: ['biryani', 'chicken', 'rice', 'spicy', 'non-veg', 'popular']
  },
  {
    id: 'item-2',
    name: 'Veg Biryani',
    ...
    spicy: true,
    popular: true,
    tags: ['biryani', 'veg', 'rice', 'spicy', 'vegetarian']
  },
  {
    id: 'item-3',
    ...
    spicy: false,
    popular: true,
    tags: ['paneer', 'curry', 'gravy', 'butter', 'vegetarian']
  },
  {
    id: 'item-4',
    name: 'Butter Naan',
    ...
    spicy: false,
    popular: true,
    tags: ['naan', 'bread', 'roti', 'butter', 'vegetarian', 'cheap', 'side']
  },
  {
    id: 'item-5',
    name: 'Masala Dosa',
    ...
    spicy: false,
    popular: true,
    tags: ['dosa', 'south indian', 'breakfast', 'vegetarian', 'crispy', 'under 100']
  },
  {
    id: 'item-6',
    name: 'Idli',
    ...
    available: true,
    spicy: false,
    tags: ['idli', 'south indian', 'healthy', 'vegetarian', 'breakfast', 'cheap']
  },
  {
    id: 'item-7',
  ...
  },
  {
    ...
    available: true,
    spicy: true,
    tags: ['chicken', 'noodles', 'hakka', 'schezwan', 'non-veg', 'spicy']
  },
  {
    id: 'item-10',
    name: 'Veg Noodles',
  ...
  },
  {
    ...
    spicy: false,
    popular: true,
    tags: ['burger', 'chicken', 'fast food', 'non-veg']
  },
  {
    id: 'item-12',
    name: 'Veg Burger',
    ...
    available: true,
    spicy: false,
    tags: ['burger', 'veg', 'fast food', 'vegetarian']
  },
  {
    id: 'item-13',
  ...
  },
  {
    ...
    spicy: false,
    popular: true,
    tags: ['dessert', 'sweet', 'gulab jamun', 'mithai', 'vegetarian', 'cheap']
  },
  {
    id: 'item-18',
    ...
    available: true,
    spicy: false,
    tags: ['brownie', 'dessert', 'chocolate', 'sweet', 'bakery', 'vegetarian']
  },
  {
    id: 'item-19',
    name: 'Coke',
    ...
    spicy: false,
    popular: true,
    tags: ['coke', 'drink', 'beverage', 'cold drink', 'soda', 'cheap']
  },
  {
    id: 'item-20',
    ...
    available: true,
    spicy: false,
    tags: ['lime juice', 'juice', 'beverage', 'healthy', 'drink', 'fresh']
  }
];
...
export const QUICK_SUGGESTIONS = [
  ...
  { label: 'Dessert', query: 'Show me desserts', icon: '🍰' }
];
